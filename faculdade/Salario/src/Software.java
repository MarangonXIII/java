    ...
    public void cadastrarFuncionario(String nome,String cidade,String estado,int tipoFuncionario,String descricaoDepartamento,double salario,double qtHorasTrabalhadas,double valorVendas,double percentualComissao,double valordahora){
        ...
        if(departamento!=null){
            ...
            switch(tipoFuncionario){
                case 1:
                    funcionario = new Mensalista(nome,cidade,estado,departamento,salario);
                    break;
                case 2:
                    funcionario = new Horista(nome,cidade,estado,departamento,qtHorasTrabalhadas,valordahora );
                    break;
                case 3:
                    funcionario = new Comissionado(nome,cidade,estado,departamento,valorVendas,percentualComissao);
                    break;
                default:
